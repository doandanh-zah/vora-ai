---
summary: "How Vora summarizes long conversations to stay within model limits"
read_when:
...
When a conversation approaches that limit, Vora **compacts** older messages
...
Vora compacts and retries).

<Info>
Before compacting, Vora automatically reminds the agent to save important
