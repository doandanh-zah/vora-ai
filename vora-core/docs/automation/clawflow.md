...
- Use `vora flows list`, `vora flows show`, and `vora flows cancel` to inspect or manage flows.

## Quick start

```bash
vora flows list
vora flows show <flow-id-or-owner-session>
vora flows cancel <flow-id-or-owner-session>
```
...
- `vora flows list` shows active and recent flows
- `vora flows show <lookup>` shows one flow and its linked tasks
- `vora flows cancel <lookup>` cancels the flow and any active child tasks
