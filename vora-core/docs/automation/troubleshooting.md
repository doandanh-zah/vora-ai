...
vora system heartbeat last
vora logs --follow
vora config get agents.defaults.heartbeat
vora channels status --probe
```
...
```bash
vora config get agents.defaults.heartbeat.activeHours
vora config get agents.defaults.heartbeat.activeHours.timezone
vora config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
vora cron list
vora logs --follow
```
