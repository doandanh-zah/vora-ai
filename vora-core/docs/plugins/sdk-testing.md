...
summary: "Testing utilities and patterns for Vora plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Vora
plugins.
...
**Import:** `vora/plugin-sdk/testing`
...
import { installCommonResolveTargetErrorCases } from "vora/plugin-sdk/testing";
...
import type { PluginRuntime } from "vora/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `vora/plugin-sdk` root barrel is rejected
...
Vora uses Vitest with V8 coverage thresholds. For plugin tests:
