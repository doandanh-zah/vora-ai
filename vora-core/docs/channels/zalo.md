...
- Install via CLI: `vora plugins install @vora/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `vora plugins install ./path/to/local/zalo-plugin`
   - From npm (if published): `vora plugins install @vora/zalo`
...
This page reflects current Vora behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `vora pairing list zalo`
  - `vora pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Vora.
...
- Example: `vora message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `vora channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `vora logs --follow`
