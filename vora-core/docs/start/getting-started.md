---
summary: "Get Vora installed and run your first chat in minutes."
read_when:
...
Install Vora, run onboarding, and chat with your AI assistant — all in
...
<Accordion title="Advanced: environment variables">
  If you run Vora as a service account or want custom paths:

- `VORA_HOME` — home directory for internal path resolution
- `VORA_STATE_DIR` — override the state directory
- `VORA_CONFIG_PATH` — override the config file path
