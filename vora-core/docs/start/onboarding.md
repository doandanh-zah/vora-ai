---
summary: "First-run setup flow for Vora (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Vora">
...
<Step title="CLI">
  ...
  The app can install the global `vora` CLI via npm/pnpm so terminal
