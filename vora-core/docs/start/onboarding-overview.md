---
summary: "Overview of Vora onboarding options and flows"
read_when:
...
Vora has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `vora onboard`                     | Launch the app            |
...
CLI command docs: [`vora onboard`](/cli/onboard)

## macOS app onboarding

Open the Vora app. The first-run wizard walks you through the same steps
