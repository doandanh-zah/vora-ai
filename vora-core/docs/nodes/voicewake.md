...
Vora treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.vora/settings/voicewake.json`

Shape:

```json
{ "triggers": ["vora", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
