---
summary: "Vora tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools Vora provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    Some plugins are **core** (shipped with Vora), others are **external**
...
These tools ship with Vora and are available without installing any plugins:
...
| `group:nodes`      | nodes                                                                                                     |
| `group:vora`   | All built-in Vora tools (excludes plugin tools)                                                       |
