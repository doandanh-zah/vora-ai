...
Set plugin-wide defaults in `~/.vora/vora.json`:
...
- Artifacts are stored under the temp subfolder: `$TMPDIR/vora-diffs`.
...
1. `browser.executablePath` in Vora config.
2. Environment variables:
   - `VORA_BROWSER_EXECUTABLE_PATH`
