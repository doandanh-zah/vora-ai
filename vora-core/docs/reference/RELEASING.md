...
Vora has three public release lanes:
...
- Run `RELEASE_TAG=vYYYY.M.D node --import tsx scripts/vora-npm-release-check.ts`
  (or the matching beta/correction tag) before approval
- After npm publish, run
  `node --import tsx scripts/vora-npm-postpublish-verify.ts YYYY.M.D`
...
- [`.github/workflows/vora-npm-release.yml`](https://github.com/vora/vora/blob/main/.github/workflows/vora-npm-release.yml)
- [`scripts/vora-npm-release-check.ts`](https://github.com/vora/vora/blob/main/scripts/vora-npm-release-check.ts)
- [`scripts/package-mac-dist.sh`](https://github.com/vora/vora/blob/main/scripts/package-mac-dist.sh)
- [`scripts/make_appcast.sh`](https://github.com/vora/vora/blob/main/scripts/make_appcast.sh)

Maintainers use the private release docs in
[`vora/maintainers/release/README.md`](https://github.com/vora/maintainers/blob/main/release/README.md)
