---
summary: "Install Vora — installer script, npm/pnpm, from source, Docker, and more"
read_when:
...
The fastest way to install. It detects your OS, installs Node if needed, installs Vora, and launches onboarding.
...
Or skip the link and use `pnpm vora ...` from inside the repo. See [Setup](/start/setup) for full development workflows.
...
```bash
vora --version      # confirm the CLI is available
vora doctor         # check for config issues
vora gateway status # verify the Gateway is running
```

## Hosting and deployment

Deploy Vora on a cloud server or VPS:
...
<CardGroup cols={3}>
  ...
  <Card title="Uninstall" href="/install/uninstall" icon="trash-2">
    Remove Vora completely.
  </Card>
</CardGroup>

## Troubleshooting: `vora` not found

If the install succeeded but `vora` is not found in your terminal:
