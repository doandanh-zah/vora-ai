---
summary: "Host Vora on a DigitalOcean Droplet"
read_when:
  - Setting up Vora on DigitalOcean
  - Looking for a simple paid VPS for Vora
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent Vora Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `vora doctor --non-interactive` and check logs with `journalctl --user -u vora-gateway.service -n 50`.
