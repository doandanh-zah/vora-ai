...
Vora has three related (but different) controls:
...
Use the inspector to see what Vora is _actually_ doing:
...
- `group:nodes`: `nodes`
- `group:vora`: all built-in Vora tools (excludes provider plugins)
