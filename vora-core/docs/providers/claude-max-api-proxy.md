...
You can point Vora at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Vora
...
- [Anthropic provider](/providers/anthropic) - Native Vora integration with Claude setup-token or API keys
