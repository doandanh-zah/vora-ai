---
summary: "Use Qianfan's unified API to access many models in Vora"
read_when:
...
3. Vora installed on your system
...
4. Copy the API key for use with Vora

## CLI setup

```bash
vora onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Vora Configuration](/gateway/configuration)
