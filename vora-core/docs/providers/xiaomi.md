---
summary: "Use Xiaomi MiMo models with Vora"
read_when:
  - You want Xiaomi MiMo models in Vora
...
Xiaomi MiMo is the API platform for **MiMo** models. Vora uses the Xiaomi
...
```bash
vora onboard --auth-choice xiaomi-api-key
# or non-interactive
vora onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
