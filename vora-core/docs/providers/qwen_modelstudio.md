...
read_when:
  - You want to use Qwen (Alibaba Cloud Model Studio) with Vora
...
```bash
# China endpoint
vora onboard --auth-choice modelstudio-standard-api-key-cn

# Global/Intl endpoint
vora onboard --auth-choice modelstudio-standard-api-key
```
...
```bash
# China endpoint
vora onboard --auth-choice modelstudio-api-key-cn

# Global/Intl endpoint
vora onboard --auth-choice modelstudio-api-key
```
