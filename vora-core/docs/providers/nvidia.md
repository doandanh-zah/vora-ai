---
summary: "Use NVIDIA's OpenAI-compatible API in Vora"
read_when:
  - You want to use NVIDIA models in Vora
...
vora onboard --auth-choice skip
vora models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
