...
describe("npm registry spec validation", () => {
  it.each([
    "@vora/voice-call",
    "@vora/voice-call@1.2.3",
    "@vora/voice-call@1.2.3-beta.4",
    "@vora/voice-call@latest",
    "@vora/voice-call@beta",
  ])("accepts %s", (spec) => {
  ...
  it.each([
    ...
    {
      spec: "git+ssh://github.com/vora/vora",
      expected: "URLs are not allowed",
    },
    {
...
describe("npm registry spec parsing helpers", () => {
  it.each([
    ...
    {
      spec: "@vora/voice-call@1.2.3-beta.1",
      expected: {
        name: "@vora/voice-call",
        raw: "@vora/voice-call@1.2.3-beta.1",
  ...
  it.each([
    {
      spec: "@vora/voice-call",
      resolvedVersion: "1.2.3-beta.1",
      expected: `Use "@vora/voice-call@beta"`,
    },
    {
      spec: "@vora/voice-call@beta",
      resolvedVersion: "1.2.3-rc.1",
