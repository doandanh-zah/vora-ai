  ...
  return withEnvAsync(
    {
      ...
      VORA_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when VORA_VERSION is not set", async () => {
  ...
  it("prefers VORA_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over VORA_SERVICE_VERSION when VORA_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        VORA_VERSION: " ",
        VORA_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when VORA_VERSION and VORA_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        VORA_VERSION: " ",
        VORA_SERVICE_VERSION: "\t",
