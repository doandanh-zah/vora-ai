...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "NO_PROXY",
  "VORA_AGENT_DIR",
  "VORA_BUNDLED_HOOKS_DIR",
  "VORA_BUNDLED_PLUGINS_DIR",
  "VORA_BUNDLED_SKILLS_DIR",
  "VORA_CONFIG_PATH",
  "VORA_GATEWAY_PASSWORD",
  "VORA_GATEWAY_SECRET",
  "VORA_GATEWAY_TOKEN",
  "VORA_HOME",
  "VORA_LIVE_ANTHROPIC_KEY",
  "VORA_LIVE_ANTHROPIC_KEYS",
  "VORA_LIVE_GEMINI_KEY",
  "VORA_LIVE_OPENAI_KEY",
  "VORA_OAUTH_DIR",
  "VORA_PROFILE",
  "VORA_STATE_DIR",
  "OPENAI_API_KEY",
...
function shouldBlockRuntimeDotEnvKey(key: string): boolean {
  // The global ~/.vora/.env (or VORA_STATE_DIR/.env) is a trusted
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.vora/.env (or VORA_STATE_DIR/.env),
