...
function resolveResolutionLimits(config: VoraConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: VoraConfig): SecretProviderConfig {
