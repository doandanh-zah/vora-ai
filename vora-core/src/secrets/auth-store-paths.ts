...
export function listAuthProfileStorePaths(config: VoraConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: VoraConfig, stateDir: string): string[] {
