...
export function buildConfigureCandidates(config: VoraConfig): ConfigureCandidate[] {
...
export function buildConfigureCandidatesForScope(params: {
  ...
  const voraCandidates = discoverConfigSecretTargets(params.config)
  ...
  return [...voraCandidates, ...authCandidates].toSorted((a, b) =>
