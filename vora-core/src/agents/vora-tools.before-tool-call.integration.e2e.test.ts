...
type PiToolsAbortModule = typeof import("./vora-tools.abort.js");
type BeforeToolCallModule = typeof import("./vora-tools.before-tool-call.js");
...
beforeEach(async () => {
  if (!wrapToolWithBeforeToolCallHook) {
    ...
    ({ wrapToolWithAbortSignal } = await import("./vora-tools.abort.js"));
    ({
      __testing: beforeToolCallTesting,
      consumeAdjustedParamsForToolCall,
      wrapToolWithBeforeToolCallHook,
    } = await import("./vora-tools.before-tool-call.js"));
  }
});
