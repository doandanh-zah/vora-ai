...
let createVoraCodingTools: typeof import("./vora-tools.js").createVoraCodingTools;

describe("createVoraTools plugin context", () => {
  beforeEach(async () => {
    resolvePluginToolsMock.mockClear();
    vi.resetModules();
    ({ createVoraTools } = await import("./vora-tools.js"));
    ({ createVoraCodingTools } = await import("./vora-tools.js"));
  });
