...
const SESSIONS_YIELD_INTERRUPT_CUSTOM_TYPE = "vora.sessions_yield_interrupt";
const SESSIONS_YIELD_CONTEXT_CUSTOM_TYPE = "vora.sessions_yield";
const SESSIONS_YIELD_ABORT_SETTLE_TIMEOUT_MS = process.env.VORA_TEST_FAST === "1" ? 250 : 2_000;
...
// Return a synthetic aborted response so vora-agent-core unwinds without a real provider call.
...
// Queue a hidden steering message so vora-agent-core injects it before the next
