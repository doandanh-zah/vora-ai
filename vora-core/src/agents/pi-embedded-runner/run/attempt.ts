...
import { resolveVoraDocsPath } from "../../docs-path.js";
...
import { subscribeEmbeddedPiSession } from "../../vora-embedded-subscribe.js";
import { createPreparedEmbeddedPiSettingsManager } from "../../pi-project-settings.js";
import { applyPiAutoCompactionGuard } from "../../pi-settings.js";
import { toClientToolDefinitions } from "../../pi-tool-definition-adapter.js";
import { createVoraCodingTools, resolveToolLoopDetectionConfig } from "../../vora-tools.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const toolsRaw = params.disableTools
      ? []
      : (() => {
          const allTools = createVoraCodingTools({
    ...
    try {
      ...
      // vora-agent-core dispatches tool calls with exact string matching, so normalize
      ...
      try {
        ...
        // double-compaction. See: https://github.com/vora/vora/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("vora:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // vora-agent-core's auto-retry resolves waitForRetry() on assistant message receipt,
      // *before* tool execution completes in the retried agent loop. Without this wait,
      // flushPendingToolResults() fires while tools are still executing, inserting
      // synthetic "missing tool result" errors and causing silent agent failures.
      // See: https://github.com/vora/vora/issues/8643
