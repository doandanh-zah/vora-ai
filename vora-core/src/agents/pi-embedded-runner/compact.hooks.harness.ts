...
export const createVoraCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createVoraCodingToolsMock.mockReset();
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureVoraModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveVoraDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../vora-tools.js", () => ({
    createVoraCodingTools: createVoraCodingToolsMock,
  }));
  ...
  vi.doMock("../vora-embedded-helpers.js", () => ({
