...
function requireWebSearchTool(config: VoraConfig, runtimeWebSearch?: RuntimeWebSearchMetadata) {
...
async function prepareAndActivate(params: { config: VoraConfig; env?: NodeJS.ProcessEnv }) {
...
describe("vora tools runtime web metadata wiring", () => {
