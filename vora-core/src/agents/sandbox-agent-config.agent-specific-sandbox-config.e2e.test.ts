...
async function resolveContext(config: VoraConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): VoraConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
