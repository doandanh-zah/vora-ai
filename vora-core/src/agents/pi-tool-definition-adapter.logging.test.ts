...
let wrapToolParamNormalization: typeof import("./vora-tools.params.js").wrapToolParamNormalization;
let CLAUDE_PARAM_GROUPS: typeof import("./vora-tools.params.js").CLAUDE_PARAM_GROUPS;
...
describe("pi tool definition adapter logging", () => {
  beforeAll(async () => {
    ...
    ({ wrapToolParamNormalization, CLAUDE_PARAM_GROUPS } = await import("./vora-tools.params.js"));
