...
const CLEANUP_STATE_KEY = Symbol.for("vora.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("vora.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("vora.sessionWriteLockWatchdogState");
