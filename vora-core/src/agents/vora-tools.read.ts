...
import { wrapEditToolWithRecovery } from "./vora-tools.host-edit.js";
import {
  CLAUDE_PARAM_GROUPS,
...
function resolveAdaptiveReadMaxBytes(options?: VoraReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createVoraReadTool(base, {
...
export function createVoraReadTool(
  base: AnyAgentTool,
  options?: VoraReadToolOptions,
): AnyAgentTool {
