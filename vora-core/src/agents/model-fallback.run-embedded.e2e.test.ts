...
function makeConfig(): VoraConfig {
...
async function withAgentWorkspace<T>(
  ...
  const root = await fs.mkdtemp(path.join(os.tmpdir(), "vora-model-fallback-"));
...
describe("runWithModelFallback + runEmbeddedVoraAgent overload policy", () => {
