...
export function resolveSubagentToolPolicy(cfg?: VoraConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: VoraConfig["tools"]): string[] | undefined {
