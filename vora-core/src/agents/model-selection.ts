...
export function isCliProvider(provider: string, cfg?: VoraConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: VoraConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: VoraConfig }): ModelCatalogEntry[] {
