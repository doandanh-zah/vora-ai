...
export const DEFAULT_SANDBOX_IMAGE = "vora-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "vora-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "vora-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "vora-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "vora-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "vora-sandbox-browser";
