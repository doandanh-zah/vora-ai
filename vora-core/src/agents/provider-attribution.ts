...
const VORA_ATTRIBUTION_PRODUCT = "Vora";
const VORA_ATTRIBUTION_ORIGINATOR = "vora";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: VORA_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: VORA_ATTRIBUTION_ORIGINATOR,
      version: identity.version,
      "User-Agent": `${VORA_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
