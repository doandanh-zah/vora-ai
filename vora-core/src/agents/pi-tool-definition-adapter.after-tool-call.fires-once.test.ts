...
let handleToolExecutionStart: typeof import("./vora-embedded-subscribe.handlers.tools.js").handleToolExecutionStart;
let handleToolExecutionEnd: typeof import("./vora-embedded-subscribe.handlers.tools.js").handleToolExecutionEnd;
...
async function loadFreshAfterToolCallModulesForTest() {
  ...
  vi.doMock("./vora-tools.before-tool-call.js", () => ({
  ...
  ({ handleToolExecutionStart, handleToolExecutionEnd } =
    await import("./vora-embedded-subscribe.handlers.tools.js"));
}
