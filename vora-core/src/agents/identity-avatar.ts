...
function resolveAvatarSource(cfg: VoraConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: VoraConfig, agentId: string): AgentAvatarResolution {
