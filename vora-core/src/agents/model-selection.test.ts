...
function resolveAnthropicOpusThinking(cfg: VoraConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<VoraConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<VoraConfig>) {
