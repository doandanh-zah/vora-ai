...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<VoraConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<VoraConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: VoraConfig): WebSearchConfig {
