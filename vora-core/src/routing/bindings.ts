...
export function listBindings(cfg: VoraConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: VoraConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: VoraConfig) {
