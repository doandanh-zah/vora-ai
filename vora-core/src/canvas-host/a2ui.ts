...
export const A2UI_PATH = "/__vora__/a2ui";

export const CANVAS_HOST_PATH = "/__vora__/canvas";

export const CANVAS_WS_PATH = "/__vora__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.voraCanvasA2UIAction.postMessage(...)
  // - Android: window.voraCanvasA2UIAction.postMessage(...)
  const handlerNames = ["voraCanvasA2UIAction"];
  ...
  globalThis.Vora = globalThis.Vora ?? {};
  globalThis.Vora.postMessage = postToNode;
  globalThis.Vora.sendUserAction = sendUserAction;
  globalThis.voraPostMessage = postToNode;
  globalThis.voraSendUserAction = sendUserAction;
