...
export function collectConfiguredModelPricingRefs(config: VoraConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: VoraConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
