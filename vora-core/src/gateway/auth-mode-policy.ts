...
export function hasAmbiguousGatewayAuthModeConfig(cfg: VoraConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: VoraConfig): void {
