 ...
 *
 * @see https://github.com/vora/vora/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an VoraConfig.
 */
export function timestampOptsFromConfig(cfg: VoraConfig): TimestampInjectionOptions {
  return {
