...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.vora.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", VORA_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.vora.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when VORA_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.vora.gateway.plist",
    },
    {
      name: "uses profile-specific label when VORA_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", VORA_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.vora.jbphoenix.plist",
    },
    {
      name: "prefers VORA_LAUNCHD_LABEL over VORA_PROFILE",
      env: {
        HOME: "/Users/test",
        VORA_PROFILE: "jbphoenix",
        VORA_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from VORA_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        VORA_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty VORA_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        VORA_PROFILE: "myprofile",
        VORA_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.vora.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
