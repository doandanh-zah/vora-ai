...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("vora.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("vora.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: VoraConfig): Promise<ContextEngine> {
