...
let originalVoraTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalVoraTestConsole = process.env.VORA_TEST_CONSOLE;
  process.env.VORA_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalVoraTestConsole === undefined) {
    delete process.env.VORA_TEST_CONSOLE;
  } else {
    process.env.VORA_TEST_CONSOLE = originalVoraTestConsole;
  }
