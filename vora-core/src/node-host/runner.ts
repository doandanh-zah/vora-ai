import { DEFAULT_GATEWAY_PORT, loadConfig, type VoraConfig } from "../config/config.js";
...
function ensureNodePathEnv(): string {
  ensureVoraCliOnPath({ pathEnv: process.env.PATH ?? "" });
...
function buildNodeHostLocalAuthConfig(config: VoraConfig): VoraConfig {
