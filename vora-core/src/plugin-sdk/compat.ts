...
const shouldWarnCompatImport =
  ...
  process.env.VORA_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "vora/plugin-sdk/compat is deprecated for new plugins. Migrate to focused vora/plugin-sdk/<subpath> imports. See https://docs.vora.ai/plugins/sdk-migration",
    {
      code: "VORA_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.vora.ai/plugins/sdk-migration",
    },
  );
}
