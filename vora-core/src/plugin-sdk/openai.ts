...
export const applyOpenAIProviderConfig: FacadeModule["applyOpenAIProviderConfig"] = ((...args: any[]) =>
  loadFacadeModule()["applyOpenAIProviderConfig"](
    ...args,
  )) as FacadeModule["applyOpenAIProviderConfig"];
export const buildOpenAICodexProvider: FacadeModule["buildOpenAICodexProvider"] = ((...args: any[]) =>
