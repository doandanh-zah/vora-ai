...
export type { VoraConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: VoraConfig, ...args: TArgs) => VoraConfig;
  applyConfig: (cfg: VoraConfig, ...args: TArgs) => VoraConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: VoraConfig, preset: TParams) => VoraConfig;
  primaryModelRef: string;
