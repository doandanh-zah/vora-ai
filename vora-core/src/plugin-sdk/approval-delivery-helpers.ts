...
import type { VoraConfig } from "./config-runtime.js";
...
export function createApproverRestrictedNativeApprovalAdapter(params: {
  ...
  isNativeDeliveryEnabled: (params: { cfg: VoraConfig; accountId?: string | null }) => boolean;
  ...
  return {
    ...
    delivery: {
      hasConfiguredDmRoute: ({ cfg }: { cfg: VoraConfig }) =>
