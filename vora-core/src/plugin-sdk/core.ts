...
import type { VoraPluginApi, VoraPluginConfigSchema } from "../plugins/types.js";
...
export type { VoraPluginToolContext, VoraPluginToolFactory } from "../plugins/types.js";
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerCliMetadata?: (api: VoraPluginApi) => void;
  registerFull?: (api: VoraPluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: VoraConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
