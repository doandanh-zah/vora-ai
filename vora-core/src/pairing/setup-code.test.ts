...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("VORA_GATEWAY_TOKEN", "");
    vi.stubEnv("VORA_GATEWAY_PASSWORD", "");
    vi.stubEnv("VORA_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses VORA_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
