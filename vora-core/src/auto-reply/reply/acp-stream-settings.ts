...
function resolveAcpStreamCoalesceIdleMs(cfg: VoraConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: VoraConfig): number {
...
export function resolveAcpProjectionSettings(cfg: VoraConfig): AcpProjectionSettings {
