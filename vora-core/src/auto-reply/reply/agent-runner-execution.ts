...
} from "../../agents/vora-embedded-helpers.js";
...
export type AgentRunLoopResult =
  | {
      kind: "success";
      runId: string;
      runResult: Awaited<ReturnType<typeof runEmbeddedVoraAgent>>;
...
export async function runAgentTurnWithFallback(params: {
  ...
  let runResult: Awaited<ReturnType<typeof runEmbeddedVoraAgent>>;
              ...
              const result = await runEmbeddedVoraAgent({
                ...
                onToolResult: onToolResult
                  ? (() => {
                      ...
                      // See: https://github.com/vora/vora/issues/11044
