...
function createMatrixThreadCommandParams(commandBody: string, cfg: VoraConfig = baseCfg) {
...
function createMatrixRoomCommandParams(commandBody: string, cfg: VoraConfig = baseCfg) {
  const params = buildCommandTestParams(commandBody, cfg, {
    Provider: "matrix",
    Surface: "matrix",
    OriginatingChannel: "matrix",
