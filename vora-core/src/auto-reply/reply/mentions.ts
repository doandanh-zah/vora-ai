...
function resolveMentionPatterns(cfg: VoraConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: VoraConfig | undefined, agentId?: string): RegExp[] {
