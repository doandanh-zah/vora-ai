...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@vora", { botUsername: "vora" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@vora args", {
        botUsername: "vora",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "vora" })).toBe(
      "/help@otherbot",
    );
  });
