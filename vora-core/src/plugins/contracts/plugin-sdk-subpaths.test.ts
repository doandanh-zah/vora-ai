...
import type {
  ...
  VoraPluginApi as CoreVoraPluginApi,
  PluginRuntime as CorePluginRuntime,
} from "vora/plugin-sdk/core";
import * as providerEntrySdk from "vora/plugin-sdk/provider-entry";
...
import type {
  ...
  VoraPluginApi as SharedVoraPluginApi,
...
import type { VoraPluginApi } from "../types.js";
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreVoraPluginApi>().toMatchTypeOf<VoraPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreVoraPluginApi>().toMatchTypeOf<SharedVoraPluginApi>();
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("vora/plugin-sdk/core"),
      importResolvedPluginSdkSubpath("vora/plugin-sdk/channel-actions"),
      importResolvedPluginSdkSubpath("vora/plugin-sdk/global-singleton"),
      importResolvedPluginSdkSubpath("vora/plugin-sdk/text-runtime"),
      importResolvedPluginSdkSubpath("vora/plugin-sdk/huggingface"),
      importResolvedPluginSdkSubpath("vora/plugin-sdk/plugin-entry"),
      importResolvedPluginSdkSubpath("vora/plugin-sdk/channel-lifecycle"),
      importResolvedPluginSdkSubpath("vora/plugin-sdk/channel-pairing"),
      importResolvedPluginSdkSubpath("vora/plugin-sdk/channel-reply-pipeline"),
      ...representativeRuntimeSmokeSubpaths.map((id) =>
        importResolvedPluginSdkSubpath(`vora/plugin-sdk/${id}`),
      ),
    ]);
