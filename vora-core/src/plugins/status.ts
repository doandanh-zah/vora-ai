...
import { normalizeVoraVersionBase } from "../config/version.js";
...
import { loadVoraPlugins } from "./loader.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeVoraVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeVoraVersionBase(plugin.version) ??
    plugin.version
  );
}
