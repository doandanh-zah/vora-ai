...
export const PLUGIN_MANIFEST_FILENAME = "vora.plugin.json";
...
// package.json "vora" metadata (used for setup/catalog)
...
export type VoraPackageStartup = {
  /**
...
export type VoraPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: VoraPackageStartup;
};
