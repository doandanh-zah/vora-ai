...
import type { PluginConfigUiHint, VoraPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: VoraPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): VoraPluginConfigSchema {
  return {
