...
export function applyGoogleGeminiModelDefault(cfg: VoraConfig): {
  next: VoraConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: VoraConfig): VoraConfig {
...
export function applyOpenAIConfig(cfg: VoraConfig): VoraConfig {
...
export function applyOpencodeGoModelDefault(cfg: VoraConfig): {
  next: VoraConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: VoraConfig): {
  next: VoraConfig;
  changed: boolean;
} {
