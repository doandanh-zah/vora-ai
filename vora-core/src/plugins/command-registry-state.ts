...
import type { VoraPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = VoraPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("vora.pluginCommandsState");
