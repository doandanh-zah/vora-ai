...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.VORA_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.VORA_SERVICE_MARKER;
    vi.useRealTimers();
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.VORA_SERVICE_MARKER = originalServiceMarker;
    }
  });
