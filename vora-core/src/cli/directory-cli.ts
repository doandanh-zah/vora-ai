    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["vora directory self --channel slack", "Show the connected account identity."],
          [
            'vora directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["vora directory groups list --channel discord", "List available groups/channels."],
          [
            "vora directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.vora.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
