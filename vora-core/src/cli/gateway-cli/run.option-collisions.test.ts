...
vi.mock("../../config/config.js", () => ({
  getConfigPath: () => "/tmp/vora-test-missing-config.json",
...
describe("gateway run option collisions", () => {
  ...
  it.each([
    ...
    delete process.env.VORA_CLI_BACKEND_LOG_OUTPUT;
    ...
    expect(process.env.VORA_CLI_BACKEND_LOG_OUTPUT).toBe("1");
  });
