...
const SANDBOX_EXAMPLES = {
  main: [
    ["vora sandbox list", "List all sandbox containers."],
    ["vora sandbox list --browser", "List only browser containers."],
    ["vora sandbox recreate --all", "Recreate all containers."],
    ["vora sandbox recreate --session main", "Recreate a specific session."],
    ["vora sandbox recreate --agent mybot", "Recreate agent containers."],
    ["vora sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["vora sandbox list", "List all sandbox containers."],
    ["vora sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["vora sandbox recreate --all", "Recreate all containers."],
    ["vora sandbox recreate --session main", "Recreate a specific session."],
    ["vora sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["vora sandbox recreate --browser --all", "Recreate only browser containers."],
    ["vora sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["vora sandbox explain", "Show effective sandbox config."],
    ["vora sandbox explain --session agent:main:main", "Explain a specific session."],
    ["vora sandbox explain --agent work", "Explain an agent sandbox."],
    ["vora sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.vora.ai/cli/sandbox")}\n`,
    )
    .action(() => {
