...
import { serveVoraChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage Vora MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose Vora channels over MCP stdio")
