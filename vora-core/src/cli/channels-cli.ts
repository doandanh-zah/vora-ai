    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["vora channels list", "List configured channels and auth profiles."],
          ["vora channels status --probe", "Run channel status checks and probes."],
          [
            "vora channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["vora channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.vora.ai/cli/channels",
        )}\n`,
    );
