...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: VoraConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: VoraConfig, mode: ChannelAuthMode): string {
