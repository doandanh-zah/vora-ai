...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "vora.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.vora/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/vora"). */
  basePath?: string;
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/vora/vora/issues/47711
   */
...
export type GatewayConfig = {
  /** Single multiplexed port for Gateway WS + HTTP (default: 27106). */
  port?: number;
  /**
