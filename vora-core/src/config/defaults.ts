...
function resolveAnthropicDefaultAuthMode(cfg: VoraConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: VoraConfig): VoraConfig {
...
export function applyTalkApiKey(config: VoraConfig): VoraConfig {
...
export function applyTalkConfigNormalization(config: VoraConfig): VoraConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: VoraConfig): VoraConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: VoraConfig): VoraConfig {
...
export function applyLoggingDefaults(cfg: VoraConfig): VoraConfig {
...
export function applyContextPruningDefaults(cfg: VoraConfig): VoraConfig {
...
export function applyCompactionDefaults(cfg: VoraConfig): VoraConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
