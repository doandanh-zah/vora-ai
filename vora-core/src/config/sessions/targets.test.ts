...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): VoraConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: VoraConfig, env: NodeJS.ProcessEnv) =>
