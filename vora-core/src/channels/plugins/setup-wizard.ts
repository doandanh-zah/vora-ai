...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: VoraConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: VoraConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: VoraConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: VoraConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: VoraConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: VoraConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: VoraConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: VoraConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: VoraConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: VoraConfig) => VoraConfig;
