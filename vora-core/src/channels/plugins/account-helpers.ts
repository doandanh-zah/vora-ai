...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: VoraConfig): string | undefined {
  ...
  function listAccountIds(cfg: VoraConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: VoraConfig): string {
