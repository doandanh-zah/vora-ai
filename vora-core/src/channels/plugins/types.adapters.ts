...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: VoraConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: VoraConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: VoraConfig) => string;
  setAccountEnabled?: (params: {
    cfg: VoraConfig;
    accountId: string;
    enabled: boolean;
  }) => VoraConfig;
  deleteAccount?: (params: { cfg: VoraConfig; accountId: string }) => VoraConfig;
  isEnabled?: (account: ResolvedAccount, cfg: VoraConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: VoraConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: VoraConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: VoraConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: VoraConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.vora.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: VoraConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: VoraConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: VoraConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: VoraConfig; accountId?: string | null }) =>
    | {
