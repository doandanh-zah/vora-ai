...
export function listChannelMessageActions(cfg: VoraConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: VoraConfig): ChannelMessageCapability[] {
