...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("vora");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "vora");
