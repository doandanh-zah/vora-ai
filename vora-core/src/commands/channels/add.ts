...
import { replaceConfigFile, type VoraConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: VoraConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as VoraConfig;
  ...
  // May trigger loadVoraPlugins on cache miss (disk scan + jiti import)
