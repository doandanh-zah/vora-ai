...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.vora.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("vora hooks list")}`,
      `  ${formatCliCommand("vora hooks enable <name>")}`,
      `  ${formatCliCommand("vora hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
