...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set VORA_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `vora dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Vora.");
  } else if (hint) {
    runtime.log(hint);
  }
}
