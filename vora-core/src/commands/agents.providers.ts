...
function resolveDefaultAccountId(cfg: VoraConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: VoraConfig): boolean {
...
export function summarizeBindings(cfg: VoraConfig, bindings: AgentBinding[]): string[] {
