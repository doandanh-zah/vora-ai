...
function collectExecSafeBinScopes(cfg: VoraConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: VoraConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: VoraConfig): {
  config: VoraConfig;
  changes: string[];
  warnings: string[];
} {
