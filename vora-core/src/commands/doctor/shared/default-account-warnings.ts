...
export function collectMissingDefaultAccountBindingWarnings(cfg: VoraConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: VoraConfig): string[] {
  const warnings: string[] = [];
