/**
 * Standalone MCP server that exposes Vora plugin-registered tools
...
function resolveTools(config: VoraConfig): AnyAgentTool[] {
...
export function createPluginToolsMcpServer(
  ...
  const server = new Server(
    { name: "vora-plugin-tools", version: VERSION },
    { capabilities: { tools: {} } },
  );
