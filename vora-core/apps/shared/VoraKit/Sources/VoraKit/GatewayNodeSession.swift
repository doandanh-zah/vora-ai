...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.vora", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.vora", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: VoraProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
