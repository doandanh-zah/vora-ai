...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: VoraProtocol.AnyCodable]?
    {
        ...
        return [
            "id": VoraProtocol.AnyCodable(identity.deviceId),
            "publicKey": VoraProtocol.AnyCodable(publicKey),
            "signature": VoraProtocol.AnyCodable(signature),
            "signedAt": VoraProtocol.AnyCodable(signedAtMs),
            "nonce": VoraProtocol.AnyCodable(nonce),
        ]
    }
}
