...
public enum VoraTalkCommand: String, Codable, Sendable {
...
public struct VoraTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct VoraTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
