...
public enum VoraCanvasA2UICommand: String, Codable, Sendable {
...
public struct VoraCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct VoraCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
