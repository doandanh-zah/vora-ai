...
public struct VoraChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct VoraChatSessionsDefaults: Codable, Sendable {
...
public struct VoraChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct VoraChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: VoraChatSessionsDefaults?
    public let sessions: [VoraChatSessionEntry]
