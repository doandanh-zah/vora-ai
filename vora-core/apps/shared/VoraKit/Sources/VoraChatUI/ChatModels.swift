...
public typealias VoraPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias VoraPlatformImage = UIImage
#endif

public struct VoraChatUsageCost: Codable, Hashable, Sendable {
...
public struct VoraChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: VoraChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(VoraChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct VoraChatMessageContent: Codable, Hashable, Sendable {
...
public struct VoraChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [VoraChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: VoraChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [VoraChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: VoraChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(VoraChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([VoraChatMessageContent].self, forKey: .content) {
...
public struct VoraChatHistoryPayload: Codable, Sendable {
...
public struct VoraSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct VoraSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [VoraSessionPreviewItem]
}

public struct VoraSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [VoraSessionPreviewEntry]

    public init(ts: Int, previews: [VoraSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct VoraChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct VoraChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct VoraAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct VoraChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct VoraGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct VoraPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: VoraPlatformImage?
...
public struct VoraChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
