...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = VoraChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = VoraChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
