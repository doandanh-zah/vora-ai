...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.vora", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        VoraPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        VoraPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
