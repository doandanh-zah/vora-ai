...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.vora", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.vora", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [VoraChatMessage] = messages.compactMap { item in
