...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.vora", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".vora/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.voraCommand(
            subcommand: "gateway",
