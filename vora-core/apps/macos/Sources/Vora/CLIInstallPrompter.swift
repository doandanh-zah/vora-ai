...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.vora", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install Vora CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .voraSelectSettingsTab, object: tab)
        }
    }
