...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.vora", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return VoraConfigFile.defaultWorkspaceURL() }
