...
enum UIStrings {
    static let welcomeTitle = "Welcome to Vora"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "vora.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: VoraChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g vora@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: VoraChatViewModel(
