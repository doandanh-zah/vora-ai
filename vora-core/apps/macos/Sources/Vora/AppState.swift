...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = VoraConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = VoraConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: VoraConfigFile.loadDict(),
        ...
        VoraConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/vora"
        state.remoteCliPath = ""
        return state
    }
}
