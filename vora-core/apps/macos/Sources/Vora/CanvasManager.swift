...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.vora", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Vora/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__vora__/a2ui/").absoluteString + "?platform=macos"
    }
