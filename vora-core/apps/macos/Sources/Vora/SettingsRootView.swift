...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .voraSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? VoraPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? VoraPaths.stateDirURL.path
...
extension Notification.Name {
    static let voraSelectSettingsTab = Notification.Name("voraSelectSettingsTab")
}
