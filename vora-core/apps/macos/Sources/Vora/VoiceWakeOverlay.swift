...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.vora", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Vora windows, but below the system’s pop-up menus.
