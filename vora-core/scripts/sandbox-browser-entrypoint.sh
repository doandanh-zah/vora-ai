...
export DISPLAY=:1
export HOME=/tmp/vora-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${VORA_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${VORA_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${VORA_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${VORA_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${VORA_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${VORA_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${VORA_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${VORA_BROWSER_NOVNC_PASSWORD:-}"
DISABLE_GRAPHICS_FLAGS="${VORA_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${VORA_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${VORA_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
