...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']vora\/plugin-sdk["']/,
    hint: "Use vora/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']vora\/plugin-sdk\/test-utils["']/,
    hint: "Use vora/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']vora\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or vora/plugin-sdk/testing for public surfaces.",
  },
  {
