...
function printUsage(): void {
  console.log(`Vora CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: vora.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "vora-cli-bench-"));
