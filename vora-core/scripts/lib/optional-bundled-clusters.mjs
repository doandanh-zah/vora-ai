...
export const OPTIONAL_BUNDLED_BUILD_ENV = "VORA_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.vora?.install?.npmSpec === "string" &&
    packageJson.vora.install.npmSpec.trim().length > 0
  );
}
