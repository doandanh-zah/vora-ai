...
if (!existsSync(generatedFacadeTypeMapDts)) {
  ...
  if (facadeTypeMapContent.includes("@vora/")) {
    console.error(
      "INVALID GENERATED FACADE TYPE MAP DTS: dist/plugin-sdk/src/generated/plugin-sdk-facade-type-map.generated.d.ts leaks @vora/* imports",
    );
    missing += 1;
  }
}
