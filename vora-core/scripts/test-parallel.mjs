...
if (rawCli.showHelp) {
  console.log(
    [
      ...
      "",
      "Runs the planner-backed Vora test wrapper.",
      "",
      "Wrapper flags:",
      ...
      "",
      "Environment:",
      "  VORA_TEST_LIST_LANES=1          Print the resolved plan before execution",
      "  VORA_TEST_SHOW_POOL_DECISION=1  Include thread/fork pool decisions in diagnostics",
    ].join("\n"),
  );
  process.exit(0);
}
...
if (process.env.VORA_TEST_LIST_LANES === "1" || rawCli.plan) {
