...
show_usage() {
    cat << EOF
clawlog - Vora Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Vora logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Vora logs flow through the macOS unified log (subsystem: ai.vora).
