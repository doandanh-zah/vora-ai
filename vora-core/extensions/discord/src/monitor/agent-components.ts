...
import { resolveHumanDelayConfig } from "vora/plugin-sdk/agent-runtime";
import {
  formatInboundEnvelope,
  resolveEnvelopeFormatOptions,
} from "vora/plugin-sdk/channel-inbound";
import { createChannelReplyPipeline } from "vora/plugin-sdk/channel-reply-pipeline";
import { enqueueSystemEvent } from "vora/plugin-sdk/channel-runtime";
import type { VoraConfig } from "vora/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "vora/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "vora/plugin-sdk/config-runtime";
import { resolveOpenProviderRuntimeGroupPolicy } from "vora/plugin-sdk/config-runtime";
import { readSessionUpdatedAt, resolveStorePath } from "vora/plugin-sdk/config-runtime";
import type { DiscordAccountConfig } from "vora/plugin-sdk/config-runtime";
import {
  buildPluginBindingResolvedText,
  parsePluginBindingApprovalCustomId,
  resolvePluginConversationBindingApproval,
} from "vora/plugin-sdk/conversation-runtime";
import { recordInboundSession } from "vora/plugin-sdk/conversation-runtime";
import { getAgentScopedMediaLocalRoots } from "vora/plugin-sdk/media-runtime";
import {
  dispatchPluginInteractiveHandler,
  type PluginInteractiveDiscordHandlerContext,
} from "vora/plugin-sdk/plugin-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "vora/plugin-sdk/reply-runtime";
import { finalizeInboundContext } from "vora/plugin-sdk/reply-runtime";
import { dispatchReplyWithBufferedBlockDispatcher } from "vora/plugin-sdk/reply-runtime";
import { createReplyReferencePlanner } from "vora/plugin-sdk/reply-runtime";
import { logVerbose } from "vora/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "vora/plugin-sdk/runtime-env";
import { logDebug, logError } from "vora/plugin-sdk/text-runtime";
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__vora_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__vora_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__vora_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__vora_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__vora_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__vora_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "Vora form";
  customId = "__vora_discord_component_modal_wildcard__";
  components = [];
