...
import { buildPluginBindingApprovalCustomId } from "vora/plugin-sdk/conversation-runtime";
...
async function createChannelRuntimeMock(
  importOriginal: () => Promise<typeof import("vora/plugin-sdk/channel-runtime")>,
) {
...
vi.mock("vora/plugin-sdk/channel-runtime", createChannelRuntimeMock);
vi.mock("vora/plugin-sdk/channel-runtime.js", createChannelRuntimeMock);
...
vi.mock("vora/plugin-sdk/config-runtime", async (importOriginal) => {
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/vora-sessions-test.json");
