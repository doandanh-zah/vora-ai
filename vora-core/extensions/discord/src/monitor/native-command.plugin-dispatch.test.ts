...
import type { NativeCommandSpec } from "vora/plugin-sdk/command-auth";
import type { VoraConfig } from "vora/plugin-sdk/config-runtime";
import { clearPluginCommands, registerPluginCommand } from "vora/plugin-sdk/plugin-runtime";
import { setDefaultChannelPluginRegistryForTests } from "vora/plugin-sdk/testing";
...
vi.mock("vora/plugin-sdk/plugin-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("vora/plugin-sdk/plugin-runtime")>();
  return {
    ...actual,
...
vi.mock("vora/plugin-sdk/reply-runtime", async (importOriginal) => {
...
function createConfig(): VoraConfig {
  return {
    channels: {
      discord: {
...
async function createNativeCommand(cfg: VoraConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: VoraConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
async function createStatusCommand(cfg: VoraConfig) {
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(async () => {
    ...
    const actualPluginRuntime = await vi.importActual<
      typeof import("vora/plugin-sdk/plugin-runtime")
    >("vora/plugin-sdk/plugin-runtime");
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("vora/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("vora/plugin-sdk/plugin-runtime").executePluginCommand,
    );
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("vora/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
    );
