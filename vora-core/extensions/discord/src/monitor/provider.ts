...
import type { VoraConfig, ReplyToMode } from "vora/plugin-sdk/config-runtime";
...
import { createConnectedChannelStatusPatch } from "vora/plugin-sdk/gateway-runtime";
import { getPluginCommandSpecs } from "vora/plugin-sdk/plugin-runtime";
import { resolveTextChunkLimit } from "vora/plugin-sdk/reply-runtime";
import {
  danger,
  isVerbose,
  logVerbose,
  shouldLogVerbose,
  warn,
} from "vora/plugin-sdk/runtime-env";
...
import { summarizeStringEntries } from "vora/plugin-sdk/text-runtime";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("vora/plugin-sdk/reply-history").HistoryEntry[]
    >();
