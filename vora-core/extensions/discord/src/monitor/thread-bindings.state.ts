...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "vora/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("vora.discordThreadBindingsState");
