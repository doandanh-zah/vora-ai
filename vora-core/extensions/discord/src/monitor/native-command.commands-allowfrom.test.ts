...
import * as pluginCommandsModule from "vora/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "vora/plugin-sdk/reply-runtime";
...
function createCommand(cfg: VoraConfig, discordConfig?: DiscordAccountConfig) {
...
function createDispatchSpy() {
  ...
  nativeCommandTesting.setDispatchReplyWithDispatcher(
    dispatcherModule.dispatchReplyWithDispatcher as typeof import("vora/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
  );
  return dispatchSpy;
}
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: VoraConfig) => void;
