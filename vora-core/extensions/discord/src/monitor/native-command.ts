...
} from "vora/plugin-sdk/command-auth";
import {
...
import type { VoraConfig, loadConfig } from "vora/plugin-sdk/config-runtime";
...
import { buildPairingReply } from "vora/plugin-sdk/conversation-runtime";
import { getAgentScopedMediaLocalRoots } from "vora/plugin-sdk/media-runtime";
import * as pluginRuntime from "vora/plugin-sdk/plugin-runtime";
import {
  resolveSendableOutboundReplyParts,
  resolveTextChunksWithFallback,
} from "vora/plugin-sdk/reply-payload";
import * as replyRuntime from "vora/plugin-sdk/reply-runtime";
...
import { createSubsystemLogger } from "vora/plugin-sdk/runtime-env";
import { loadWebMedia } from "vora/plugin-sdk/web-media";
...
type DiscordConfig = NonNullable<VoraConfig["channels"]>["discord"];
