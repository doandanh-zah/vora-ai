...
import { peekSystemEvents, resetSystemEventsForTest } from "vora/plugin-sdk/testing";
...
describe("agent components", () => {
  ...
  const createCfg = (): VoraConfig => ({}) as VoraConfig;
  ...
  it("sends pairing reply when DM sender is not allowlisted", async () => {
    ...
    expect(pairingText).toContain(`vora pairing approve discord ${code}`);
