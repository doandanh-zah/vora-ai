...
import type { HistoryEntry } from "vora/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "vora/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("vora/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("vora/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("vora/plugin-sdk/config-runtime").VoraConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
