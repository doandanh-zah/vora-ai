...
async function createConversationRuntimeMock(
  importOriginal: () => Promise<typeof import("vora/plugin-sdk/conversation-runtime")>,
) {
...
vi.mock("vora/plugin-sdk/security-runtime", (importOriginal) =>
  createAllowFromRuntimeMock(importOriginal),
);

vi.mock("vora/plugin-sdk/conversation-runtime", createConversationRuntimeMock);
vi.mock("vora/plugin-sdk/conversation-runtime.js", createConversationRuntimeMock);
