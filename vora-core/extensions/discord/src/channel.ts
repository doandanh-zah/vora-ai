...
} from "vora/plugin-sdk/allowlist-config-edit";
import { createScopedDmSecurityResolver } from "vora/plugin-sdk/channel-config-helpers";
import { createPairingPrefixStripper } from "vora/plugin-sdk/channel-pairing";
import { createOpenProviderConfiguredRouteWarningCollector } from "vora/plugin-sdk/channel-policy";
import { resolveTargetsWithOptionalToken } from "vora/plugin-sdk/channel-targets";
import { createChatChannelPlugin } from "vora/plugin-sdk/core";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "vora/plugin-sdk/directory-runtime";
import {
  createRuntimeOutboundDelegates,
  resolveOutboundSendDep,
} from "vora/plugin-sdk/outbound-runtime";
import { normalizeMessageChannel } from "vora/plugin-sdk/routing";
import {
  createComputedAccountStatusAdapter,
  createDefaultChannelRuntimeState,
} from "vora/plugin-sdk/status-helpers";
import {
    ...
    base: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "- Forms: add `components.modal` (title, fields). Vora adds a trigger button and routes submissions as new messages.",
        ],
      },
      messaging: {
