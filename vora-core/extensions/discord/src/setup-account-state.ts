import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "vora/plugin-sdk/account-id";
import { listCombinedAccountIds } from "vora/plugin-sdk/account-resolution";
...
export function listDiscordSetupAccountIds(cfg: VoraConfig): string[] {
...
export function resolveDefaultDiscordSetupAccountId(cfg: VoraConfig): string {
