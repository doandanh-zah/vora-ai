...
import { normalizeAccountId } from "vora/plugin-sdk/account-id";
import { resolveAccountEntry } from "vora/plugin-sdk/routing";
import type { DiscordAccountConfig, DiscordActionConfig, VoraConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: VoraConfig): ResolvedDiscordAccount[] {
