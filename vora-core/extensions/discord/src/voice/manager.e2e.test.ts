...
vi.mock("vora/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("vora/plugin-sdk/routing")>();
  return {
    ...actual,
...
vi.mock("vora/plugin-sdk/agent-runtime", async (importOriginal) => {
...
vi.mock("vora/plugin-sdk/media-understanding-runtime", () => ({
