...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<VoraConfig["channels"]>["discord"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<VoraConfig["channels"]>["discord"]>>,
): VoraConfig {
  return {
    channels: {
      discord: {
