...
import type { GetReplyOptions, MsgContext } from "vora/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("vora/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as VoraConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("vora/plugin-sdk/media-runtime")>,
) {
...
vi.mock("vora/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("vora/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("vora/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
