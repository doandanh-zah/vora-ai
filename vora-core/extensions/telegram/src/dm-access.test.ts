import type { createChannelPairingChallengeIssuer } from "vora/plugin-sdk/channel-pairing";
...
vi.mock("vora/plugin-sdk/channel-pairing", () => ({
...
vi.mock("vora/plugin-sdk/conversation-runtime", () => ({
