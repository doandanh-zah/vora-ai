...
} from "vora/plugin-sdk/command-auth-native";
import {
...
import { getRuntimeConfigSnapshot } from "vora/plugin-sdk/config-runtime";
...
import {
  ...
  resolveChunkMode,
} from "vora/plugin-sdk/reply-dispatch-runtime";
...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): VoraConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: VoraConfig): TelegramAccountConfig => {
    try {
