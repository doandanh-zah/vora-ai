...
import { createAllowlistProviderRouteAllowlistWarningCollector } from "vora/plugin-sdk/channel-policy";
import { attachChannelToResult } from "vora/plugin-sdk/channel-send-result";
import { createChatChannelPlugin } from "vora/plugin-sdk/core";
import { createChannelDirectoryAdapter } from "vora/plugin-sdk/directory-runtime";
import {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as VoraConfig;
