...
import type { ChannelGroupPolicy } from "vora/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "vora/plugin-sdk/config-runtime";
import type { RuntimeEnv } from "vora/plugin-sdk/runtime-env";
...
type GetPluginCommandSpecsFn =
  typeof import("vora/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("vora/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("vora/plugin-sdk/plugin-runtime").executePluginCommand;
type DispatchReplyWithBufferedBlockDispatcherFn =
  typeof import("vora/plugin-sdk/reply-dispatch-runtime").dispatchReplyWithBufferedBlockDispatcher;
type DispatchReplyWithBufferedBlockDispatcherResult = Awaited<
  ReturnType<DispatchReplyWithBufferedBlockDispatcherFn>
>;
type RecordInboundSessionMetaSafeFn =
  typeof import("vora/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
...
vi.mock("vora/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("vora/plugin-sdk/reply-dispatch-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("vora/plugin-sdk/reply-dispatch-runtime")>();
  return {
    ...actual,
...
vi.mock("vora/plugin-sdk/conversation-runtime", async (importOriginal) => {
...
vi.mock("vora/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("vora/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as VoraConfig)),
