...
import type { ChannelSetupAdapter, ChannelSetupDmPolicy } from "vora/plugin-sdk/setup";
import { formatCliCommand, formatDocsLink } from "vora/plugin-sdk/setup-tools";
import type { TelegramNetworkConfig } from "vora/plugin-sdk/telegram-core";
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://vora.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("vora logs --follow")}\` (safest)`,
