...
import { formatAllowFromLowercase } from "vora/plugin-sdk/allow-from";
import {
  adaptScopedAccountAccessor,
  createScopedChannelConfigAdapter,
} from "vora/plugin-sdk/channel-config-helpers";
import { createChannelPluginBase } from "vora/plugin-sdk/core";
 ...
 */
function isBlockedByMultiBotGuard(cfg: VoraConfig, accountId: string): boolean {
