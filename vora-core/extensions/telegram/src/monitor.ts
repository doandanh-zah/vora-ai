...
import { resolveAgentMaxConcurrent } from "vora/plugin-sdk/config-runtime";
import type { VoraConfig } from "vora/plugin-sdk/config-runtime";
import { loadConfig } from "vora/plugin-sdk/config-runtime";
import { waitForAbortSignal } from "vora/plugin-sdk/runtime-env";
import { registerUnhandledRejectionHandler } from "vora/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: VoraConfig): RunOptions<unknown> {
  return {
    sink: {
