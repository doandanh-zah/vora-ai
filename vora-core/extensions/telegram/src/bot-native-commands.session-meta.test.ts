...
import type { ResolvedAgentRoute } from "vora/plugin-sdk/routing";
...
type ResolveConfiguredBindingRouteFn =
  typeof import("vora/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("vora/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
vi.mock("vora/plugin-sdk/command-auth", async (importOriginal) => {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/vora-sessions.json");
