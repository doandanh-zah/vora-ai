...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<VoraConfig["channels"]>["telegram"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<VoraConfig["channels"]>["telegram"]>>,
): VoraConfig {
  return {
    channels: {
      telegram: {
