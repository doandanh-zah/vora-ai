...
vi.mock("vora/plugin-sdk/agent-runtime", () => ({
...
vi.mock("vora/plugin-sdk/media-runtime", () => ({
...
const TEST_CACHE_DIR = "/tmp/vora-test-sticker-cache/telegram";
...
describe("sticker-cache", () => {
  beforeEach(async () => {
    process.env.VORA_STATE_DIR = "/tmp/vora-test-sticker-cache";
    fs.rmSync("/tmp/vora-test-sticker-cache", { recursive: true, force: true });
