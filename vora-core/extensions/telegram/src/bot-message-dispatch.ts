...
import {
  ...
  resolveStorePath,
} from "vora/plugin-sdk/config-runtime";
import type {
  VoraConfig,
  ReplyToMode,
...
import { clearHistoryEntriesIfEnabled } from "vora/plugin-sdk/reply-history";
...
import { resolveAutoTopicLabelConfig, generateTopicLabel } from "vora/plugin-sdk/reply-runtime";
import { danger, logVerbose } from "vora/plugin-sdk/runtime-env";
...
async function resolveStickerVisionSupport(cfg: VoraConfig, agentId: string) {
  try {
