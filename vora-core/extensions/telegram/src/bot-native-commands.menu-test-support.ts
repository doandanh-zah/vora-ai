import type { SkillCommandSpec } from "vora/plugin-sdk/command-auth";
import type { RuntimeEnv } from "vora/plugin-sdk/runtime-env";
import { expect, vi } from "vitest";
import type { VoraConfig } from "../runtime-api.js";
...
const skillCommandMocks = vi.hoisted(() => ({
  listSkillCommandsForAgents: vi.fn<
    (params: { cfg: VoraConfig; agentIds?: string[] }) => SkillCommandSpec[]
  >(() => []),
}));
