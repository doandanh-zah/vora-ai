...
import {
  ...
  type VoraConfig,
} from "vora/plugin-sdk/account-core";
import {
  listBoundAccountIds,
  resolveDefaultAgentBoundAccountId,
} from "vora/plugin-sdk/routing";
import { formatSetExplicitDefaultInstruction } from "vora/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "vora/plugin-sdk/runtime-env";
import type {
  TelegramAccountConfig,
  TelegramActionConfig,
} from "vora/plugin-sdk/telegram-core";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.VORA_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: VoraConfig): string[] {
...
export function listTelegramAccountIds(cfg: VoraConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: VoraConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/vora/vora/issues/30673
...
export function listEnabledTelegramAccounts(cfg: VoraConfig): ResolvedTelegramAccount[] {
