import { resolveAccountWithDefaultFallback } from "vora/plugin-sdk/account-core";
import type { VoraConfig } from "vora/plugin-sdk/config-runtime";
import { coerceSecretRef } from "vora/plugin-sdk/config-runtime";
import { tryReadSecretFileSync } from "vora/plugin-sdk/core";
import { resolveDefaultSecretProviderAlias } from "vora/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "vora/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "vora/plugin-sdk/secret-input";
import type { TelegramAccountConfig } from "vora/plugin-sdk/telegram-core";
import {
...
function inspectTokenValue(params: { cfg: VoraConfig; value: unknown }): {
  token: string;
