...
import { createFinalizableDraftLifecycle } from "vora/plugin-sdk/channel-lifecycle";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("vora.telegramDraftStreamState");
