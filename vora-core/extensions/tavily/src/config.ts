...
export function resolveTavilySearchConfig(cfg?: VoraConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: VoraConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: VoraConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
